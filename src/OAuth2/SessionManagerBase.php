...
use KrystalCode\Api\Session\OAuth2\AccessTokenSession;
...
/**
 * Provides a base class for managers of sessions that use OAuth2 flows.
 *
...
abstract class SessionManagerBase implements SessionManagerInterface
{
     ...
     *   The access token.
     */
    abstract protected function getAccessToken(): AccessTokenInterface;

    /**
     * Returns the required grant options.
     *
     * @return array
     *   An array containing the names of the required grant options.
     */
    abstract protected function getRequiredGrantOptions(): array;

    /**
     * Constructs a new SessionManagerBase.
     *
     ...
     *   `KrystalCode\Api\Session\OAuth2\SessionManagerBase::setOptions()`.
     */
     ...
     *
     * Child classes should document any additional options that they may
     * support.
     *
    ...
    {
        foreach ($this->getRequiredGrantOptions() as $option) {
